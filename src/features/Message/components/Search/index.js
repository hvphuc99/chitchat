...
function Search(props) {
  ...
  const { showSearchFormFullScreen } = useSelector((state) => state.message);
  ...
  const handleClickOpenSearchFormFullScreen = () => {
    dispatch(setShowSearchFormFullScreen(true));
  };

  const handleClickBack = () => {
    dispatch(setShowSearchFormFullScreen(false));
    resetSearchForm();
    setNotFound(false);
  };
      ...
      {isSmallSize && (
        <>
          ...
          {showSearchFormFullScreen && (
            <div className={classes.searchFormFullScreenRoot}>
              <div className={classes.searchFormFullScreen}>
                ...
                <div className={classes.searchFormFullScreenResult}>
                  {renderResult()}
                </div>
              </div>
            </div>
